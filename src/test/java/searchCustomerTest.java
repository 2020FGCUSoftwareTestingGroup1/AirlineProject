...
class searchCustomerTest {
  ...
  /**
   * An integration testing method which catches an exception on the event that the user has failed
   * to update a customer.
    * @throws SQLException Catches the exception in which the update has failed to execute.
   */
  @Test
